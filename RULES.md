...
- Always screenshot localhost before marking UI tasks complete
- Use Playwright for responsive design validation
- Document visual changes with before/after screenshots
- Test cross-browser compatibility for production features
- Validate accessibility features visually
