...
| "implement UI component" | simple | frontend | frontend persona, Magic, Playwright, --c7 | 94% |
| "fix responsive design" | moderate | frontend | frontend persona, ui-designer persona, Playwright | 92% |
| "visual testing" | moderate | testing | test-writer-fixer persona, Playwright, --validate | 95% |
| "screenshot app" | simple | frontend | ui-designer persona, Playwright | 95% |
